...
const Whitelist = () => {
  ...
  function getValidIndicator() {
    const indicator = query.get("indicator");
    if (indicator == null || !ethers.utils.isAddress(indicator)) {
      return "0x0000000000000000000000000000000000000000";
    }
    return indicator;
  }

  setCookie("indicator", getValidIndicator(), 1);
      ...
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div className="max-w-xl">
          ...
          <p className="pt-6 pb-2">
            Join the whitelist by connecting your Discord account and wallet.
          ...
          <p className="text-opacity-70 pb-6 text-gray-500 text-sm">
            ...
            upon joining the whitelist.
          </p>
          <div className="flex flex-col lg:flex-row m-auto">
            <div className="grid flex-grow h-32 card rounded-box place-items-center">
              <a className="btn btn-outline gap-2" href={discordApi}>
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 71 55"
